...
# PYTHON_EXEC_MAX_MEMORY (8GB default, POSIX/RLIMIT_AS only) is read and
# enforced entirely inside the worker (_python_worker.py) - not here, since
# the limit applies to the worker's own process, not this parent.
